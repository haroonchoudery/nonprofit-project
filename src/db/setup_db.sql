...
CREATE TABLE IF NOT EXISTS tax_exempt_organizations (
  ...
  net_assets_boy INT,
  net_assets_eoy INT,
  annual_total_revenue_growth FLOAT(5,2),
  annual_total_expenses_growth FLOAT(5,2),
  annual_total_assets_growth FLOAT(5,2),
  annual_total_liabilities_growth FLOAT(5,2),
  annual_net_assets_growth FLOAT(5,2),
  cy_operating_reserve FLOAT(5,2),
  cy_operating_efficiency FLOAT(5,2),
  cy_net_margin FLOAT(6,2),
  cy_leverage_efficiency FLOAT(5,2),
  cy_debt_ratio FLOAT(5,2),
  cy_financial_leverage FLOAT(5,2),
  cy_credit_score INT,
